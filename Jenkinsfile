        ...
        stage('Deploy to Kubernetes') {
            steps {
                script {
                    ...
                    docker.image('bitnami/kubectl').inside("--entrypoint='' --network ci_network -v /var/jenkins_home/.kube:/home/1000/.kube -v /var/jenkins_home/.minikube:/home/1000/.minikube") {
